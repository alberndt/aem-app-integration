...
//            final ProcessingItem htmlRes = HttpDownloadUtil.download(baseURI, ref, IntegrationResourceType.HTML);
//
//            // execute tasks
...
//            final ProcessingItem htmlSnippetRes = ProcessingItemImpl.create(IntegrationResourceType.HTML_SNIPPET, htmlSnippetElements.outerHtml());
//
//            // execute tasks
...
//
//
//    private void executeTasks(ProcessingItem resource) {
